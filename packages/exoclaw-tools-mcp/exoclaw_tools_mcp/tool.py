"""MCP client: connects to MCP servers and wraps their tools as native exoclaw tools."""
...
class MCPToolWrapper(ToolBase):
    """Wraps a single MCP server tool as an exoclaw Tool."""
        ...
        try:
            ...
            if not transport_type:
                if cfg.command:
                    ...
                    # Convention: URLs ending with /sse use SSE; others use streamableHttp
                    transport_type = (
